...
<?php if ($audittrail->username->Visible) { // username ?>
		<th class="<?php echo $audittrail->username->headerCellClass() ?>"><span id="elh_audittrail_username" class="audittrail_username"><?php echo $audittrail->username->caption() ?></span></th>
<?php } ?>
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_username" class="audittrail_username">
