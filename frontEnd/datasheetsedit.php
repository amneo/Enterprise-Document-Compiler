...
// Create page object
$datasheets_edit = new datasheets_edit();
...
var fdatasheetsedit = currentForm = new ew.Form("fdatasheetsedit", "edit");

// Validate form
fdatasheetsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($datasheets_edit->partno->Required) { ?>
		...
		<?php } ?>
		<?php if ($datasheets_edit->dataSheetFile->Required) { ?>
		...
		<?php } ?>
		<?php if ($datasheets_edit->manufacturer->Required) { ?>
		...
		<?php if ($datasheets_edit->cddno->Required) { ?>
		...
		<?php } ?>
		<?php if ($datasheets_edit->expirydt->Required) { ?>
		...
		<?php if ($datasheets_edit->highlighted->Required) { ?>
		...
		<?php } ?>
		<?php if ($datasheets_edit->coo->Required) { ?>
		...
		<?php } ?>
		<?php if ($datasheets_edit->hssCode->Required) { ?>
		...
		<?php } ?>
		<?php if ($datasheets_edit->systrade->Required) { ?>
		...
		<?php } ?>
		<?php if ($datasheets_edit->isdatasheet->Required) { ?>
...
fdatasheetsedit.lists["x_manufacturer"].options = <?php echo JsonEncode($datasheets_edit->manufacturer->lookupOptions()) ?>;
fdatasheetsedit.autoSuggests["x_manufacturer"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fdatasheetsedit.lists["x_duration"] = <?php echo $datasheets_edit->duration->Lookup->toClientList() ?>;
fdatasheetsedit.lists["x_duration"].options = <?php echo JsonEncode($datasheets_edit->duration->options(FALSE, TRUE)) ?>;
fdatasheetsedit.lists["x_highlighted"] = <?php echo $datasheets_edit->highlighted->Lookup->toClientList() ?>;
fdatasheetsedit.lists["x_highlighted"].options = <?php echo JsonEncode($datasheets_edit->highlighted->options(FALSE, TRUE)) ?>;
fdatasheetsedit.lists["x_coo"] = <?php echo $datasheets_edit->coo->Lookup->toClientList() ?>;
fdatasheetsedit.lists["x_coo"].options = <?php echo JsonEncode($datasheets_edit->coo->lookupOptions()) ?>;
fdatasheetsedit.autoSuggests["x_coo"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fdatasheetsedit.lists["x_systrade"] = <?php echo $datasheets_edit->systrade->Lookup->toClientList() ?>;
...
<?php $datasheets_edit->showPageHeader(); ?>
<?php
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo (int)$datasheets_edit->IsModal ?>">
...
<?php if ($datasheets_edit->IsMobileOrModal) { ?>
	<div id="r_partno" class="form-group row">
		<label id="elh_datasheets_partno" for="x_partno" class="<?php echo $datasheets_edit->LeftColumnClass ?>"><?php echo $datasheets->partno->caption() ?><?php echo ($datasheets->partno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $datasheets_edit->RightColumnClass ?>"><div<?php echo $datasheets->partno->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_partno">
		<td class="<?php echo $datasheets_edit->TableLeftColumnClass ?>"><span id="elh_datasheets_partno"><?php echo $datasheets->partno->caption() ?><?php echo ($datasheets->partno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($datasheets_edit->IsMobileOrModal) { ?>
	<div id="r_manufacturer" class="form-group row">
		<label id="elh_datasheets_manufacturer" class="<?php echo $datasheets_edit->LeftColumnClass ?>"><?php echo $datasheets->manufacturer->caption() ?><?php echo ($datasheets->manufacturer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $datasheets_edit->RightColumnClass ?>"><div<?php echo $datasheets->manufacturer->cellAttributes() ?>>
<?php if (!$datasheets->isConfirm()) { ?>
...
<?php } else { ?>
	<tr id="r_manufacturer">
		<td class="<?php echo $datasheets_edit->TableLeftColumnClass ?>"><span id="elh_datasheets_manufacturer"><?php echo $datasheets->manufacturer->caption() ?><?php echo ($datasheets->manufacturer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($datasheets_edit->IsMobileOrModal) { ?>
	<div id="r_cddFile" class="form-group row">
		<label id="elh_datasheets_cddFile" class="<?php echo $datasheets_edit->LeftColumnClass ?>"><?php echo $datasheets->cddFile->caption() ?><?php echo ($datasheets->cddFile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $datasheets_edit->RightColumnClass ?>"><div<?php echo $datasheets->cddFile->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_cddFile">
		<td class="<?php echo $datasheets_edit->TableLeftColumnClass ?>"><span id="elh_datasheets_cddFile"><?php echo $datasheets->cddFile->caption() ?><?php echo ($datasheets->cddFile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($datasheets_edit->IsMobileOrModal) { ?>
	<div id="r_thirdPartyFile" class="form-group row">
		<label id="elh_datasheets_thirdPartyFile" class="<?php echo $datasheets_edit->LeftColumnClass ?>"><?php echo $datasheets->thirdPartyFile->caption() ?><?php echo ($datasheets->thirdPartyFile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $datasheets_edit->RightColumnClass ?>"><div<?php echo $datasheets->thirdPartyFile->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_thirdPartyFile">
		<td class="<?php echo $datasheets_edit->TableLeftColumnClass ?>"><span id="elh_datasheets_thirdPartyFile"><?php echo $datasheets->thirdPartyFile->caption() ?><?php echo ($datasheets->thirdPartyFile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($datasheets_edit->IsMobileOrModal) { ?>
	<div id="r_cover" class="form-group row">
		<label id="elh_datasheets_cover" class="<?php echo $datasheets_edit->LeftColumnClass ?>"><?php echo $datasheets->cover->caption() ?><?php echo ($datasheets->cover->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $datasheets_edit->RightColumnClass ?>"><div<?php echo $datasheets->cover->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_cover">
		<td class="<?php echo $datasheets_edit->TableLeftColumnClass ?>"><span id="elh_datasheets_cover"><?php echo $datasheets->cover->caption() ?><?php echo ($datasheets->cover->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($datasheets_edit->IsMobileOrModal) { ?>
	<div id="r_isdatasheet" class="form-group row">
		<label id="elh_datasheets_isdatasheet" class="<?php echo $datasheets_edit->LeftColumnClass ?>"><?php echo $datasheets->isdatasheet->caption() ?><?php echo ($datasheets->isdatasheet->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
	<tr id="r_isdatasheet">
		<td class="<?php echo $datasheets_edit->TableLeftColumnClass ?>"><span id="elh_datasheets_isdatasheet"><?php echo $datasheets->isdatasheet->caption() ?><?php echo ($datasheets->isdatasheet->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php if ($datasheets_edit->IsMobileOrModal) { ?>
	<div id="r_nativeFiles" class="form-group row">
		<label id="elh_datasheets_nativeFiles" for="x_nativeFiles" class="<?php echo $datasheets_edit->LeftColumnClass ?>"><?php echo $datasheets->nativeFiles->caption() ?><?php echo ($datasheets->nativeFiles->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
	<tr id="r_nativeFiles">
		<td class="<?php echo $datasheets_edit->TableLeftColumnClass ?>"><span id="elh_datasheets_nativeFiles"><?php echo $datasheets->nativeFiles->caption() ?><?php echo ($datasheets->nativeFiles->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
...
<?php
$datasheets_edit->showPageFooter();
if (DEBUG_ENABLED)
