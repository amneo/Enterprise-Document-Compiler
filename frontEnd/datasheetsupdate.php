...
fdatasheetsupdate.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($datasheets_update->tittle->Required) { ?>
			elm = this.getElements("x" + infix + "_tittle");
			uelm = this.getElements("u" + infix + "_tittle");
			if (uelm && uelm.checked) {
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
...
fdatasheetsupdate.lists["x_coo"] = <?php echo $datasheets_update->coo->Lookup->toClientList() ?>;
fdatasheetsupdate.lists["x_coo"].options = <?php echo JsonEncode($datasheets_update->coo->lookupOptions()) ?>;
fdatasheetsupdate.autoSuggests["x_coo"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php if ($datasheets_update->IsMobileOrModal) { ?>
	<div id="r_tittle" class="form-group row">
		<label for="x_tittle" class="<?php echo $datasheets_update->LeftColumnClass ?>"><div class="form-check">
<?php if (!$datasheets->isConfirm()) { ?>
<input type="checkbox" name="u_tittle" id="u_tittle" class="form-check-input ew-multi-select" value="1"<?php echo ($datasheets->tittle->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="hidden" name="u_tittle" id="u_tittle" value="<?php echo $datasheets->tittle->MultiUpdate ?>">
<input type="checkbox" class="form-check-input" disabled<?php echo ($datasheets->tittle->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } ?>
<label class="form-check-label" for="u_tittle"><?php echo $datasheets->tittle->caption() ?></label></div></label>
		<div class="<?php echo $datasheets_update->RightColumnClass ?>"><div<?php echo $datasheets->tittle->cellAttributes() ?>>
<?php if (!$datasheets->isConfirm()) { ?>
...
<?php } else { ?>
	<tr id="r_tittle">
		<td class="<?php echo $datasheets_update->TableLeftColumnClass ?>"<?php echo $datasheets->tittle->cellAttributes() ?>><span id="elh_datasheets_tittle"><div class="form-check">
<?php if (!$datasheets->isConfirm()) { ?>
<input type="checkbox" name="u_tittle" id="u_tittle" class="form-check-input ew-multi-select" value="1"<?php echo ($datasheets->tittle->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="hidden" name="u_tittle" id="u_tittle" value="<?php echo $datasheets->tittle->MultiUpdate ?>">
<input type="checkbox" class="form-check-input" disabled<?php echo ($datasheets->tittle->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } ?>
<label class="form-check-label" for="u_tittle"><?php echo $datasheets->tittle->caption() ?></label></div></span></td>
...
<?php if ($datasheets_update->IsMobileOrModal) { ?>
	<div id="r_coo" class="form-group row">
		<label class="<?php echo $datasheets_update->LeftColumnClass ?>"><div class="form-check">
<?php if (!$datasheets->isConfirm()) { ?>
<input type="checkbox" name="u_coo" id="u_coo" class="form-check-input ew-multi-select" value="1"<?php echo ($datasheets->coo->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="hidden" name="u_coo" id="u_coo" value="<?php echo $datasheets->coo->MultiUpdate ?>">
<input type="checkbox" class="form-check-input" disabled<?php echo ($datasheets->coo->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } ?>
<label class="form-check-label" for="u_coo"><?php echo $datasheets->coo->caption() ?></label></div></label>
		<div class="<?php echo $datasheets_update->RightColumnClass ?>"><div<?php echo $datasheets->coo->cellAttributes() ?>>
<?php if (!$datasheets->isConfirm()) { ?>
...
<script>
fdatasheetsupdate.createAutoSuggest({"id":"x_coo","forceSelect":false});
</script>
...
<?php } else { ?>
	<tr id="r_coo">
		<td class="<?php echo $datasheets_update->TableLeftColumnClass ?>"<?php echo $datasheets->coo->cellAttributes() ?>><span id="elh_datasheets_coo"><div class="form-check">
<?php if (!$datasheets->isConfirm()) { ?>
<input type="checkbox" name="u_coo" id="u_coo" class="form-check-input ew-multi-select" value="1"<?php echo ($datasheets->coo->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="hidden" name="u_coo" id="u_coo" value="<?php echo $datasheets->coo->MultiUpdate ?>">
<input type="checkbox" class="form-check-input" disabled<?php echo ($datasheets->coo->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } ?>
<label class="form-check-label" for="u_coo"><?php echo $datasheets->coo->caption() ?></label></div></span></td>
...
<?php if ($datasheets_update->IsMobileOrModal) { ?>
	<div id="r_hssCode" class="form-group row">
		<label for="x_hssCode" class="<?php echo $datasheets_update->LeftColumnClass ?>"><div class="form-check">
<?php if (!$datasheets->isConfirm()) { ?>
<input type="checkbox" name="u_hssCode" id="u_hssCode" class="form-check-input ew-multi-select" value="1"<?php echo ($datasheets->hssCode->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="hidden" name="u_hssCode" id="u_hssCode" value="<?php echo $datasheets->hssCode->MultiUpdate ?>">
<input type="checkbox" class="form-check-input" disabled<?php echo ($datasheets->hssCode->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } ?>
<label class="form-check-label" for="u_hssCode"><?php echo $datasheets->hssCode->caption() ?></label></div></label>
		<div class="<?php echo $datasheets_update->RightColumnClass ?>"><div<?php echo $datasheets->hssCode->cellAttributes() ?>>
<?php if (!$datasheets->isConfirm()) { ?>
...
<?php } else { ?>
	<tr id="r_hssCode">
		<td class="<?php echo $datasheets_update->TableLeftColumnClass ?>"<?php echo $datasheets->hssCode->cellAttributes() ?>><span id="elh_datasheets_hssCode"><div class="form-check">
<?php if (!$datasheets->isConfirm()) { ?>
<input type="checkbox" name="u_hssCode" id="u_hssCode" class="form-check-input ew-multi-select" value="1"<?php echo ($datasheets->hssCode->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="hidden" name="u_hssCode" id="u_hssCode" value="<?php echo $datasheets->hssCode->MultiUpdate ?>">
<input type="checkbox" class="form-check-input" disabled<?php echo ($datasheets->hssCode->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } ?>
<label class="form-check-label" for="u_hssCode"><?php echo $datasheets->hssCode->caption() ?></label></div></span></td>
