...
faudittrailadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($audittrail_add->username->Required) { ?>
...
<?php if ($audittrail_add->IsMobileOrModal) { ?>
	<div id="r_username" class="form-group row">
		<label id="elh_audittrail_username" for="x_username" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->username->caption() ?><?php echo ($audittrail->username->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $audittrail_add->RightColumnClass ?>"><div<?php echo $audittrail->username->cellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_username">
		<td class="<?php echo $audittrail_add->TableLeftColumnClass ?>"><span id="elh_audittrail_username"><?php echo $audittrail->username->caption() ?><?php echo ($audittrail->username->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></td>
