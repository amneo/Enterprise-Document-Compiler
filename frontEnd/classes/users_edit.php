...
class users_edit extends users
{
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$Security->isAdmin() && $Security->isLoggedIn()) { // Non system admin
				if (SameString($this->userLoginId->CurrentValue, CurrentUserID())) {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// uProfile
			$this->uProfile->setDbValueDef($rsnew, $this->uProfile->CurrentValue, NULL, $this->uProfile->ReadOnly);

			// uReportsTo
			$this->uReportsTo->setDbValueDef($rsnew, $this->uReportsTo->CurrentValue, NULL, $this->uReportsTo->ReadOnly);
