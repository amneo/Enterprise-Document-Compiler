...
class userlevelpermissions_add extends userlevelpermissions
{
	...
	public function loadRowValues($rs = NULL)
	{
		...
		if (array_key_exists('EV___tablename', $rs->fields)) {
			$this->_tablename->VirtualValue = $rs->fields('EV___tablename'); // Set up virtual field value
		} else {
			$this->_tablename->VirtualValue = ""; // Clear value
		}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$arwrk = array();
			$arwrk[1] = HtmlEncode($this->_tablename->CurrentValue);
