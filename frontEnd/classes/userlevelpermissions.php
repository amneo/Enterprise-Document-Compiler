...
class userlevelpermissions extends DbTable
{
	...
	public function __construct()
	{
		...
		// tablename
		$this->_tablename = new DbField('userlevelpermissions', 'userlevelpermissions', 'x__tablename', 'tablename', '"tablename"', '"tablename"', 200, -1, FALSE, '"EV___tablename"', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->_tablename->Lookup = new Lookup('tablename', 'userlevelpermissions', FALSE, 'tablename', ["tablename","","",""], [], [], [], [], [], [], '', '');
	...
	public function getSqlSelectList() // Select for List page
	{
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT \"tablename\" FROM \"public\".\"userlevelpermissions\" \"TMP_LOOKUPTABLE\" WHERE \"TMP_LOOKUPTABLE\".\"tablename\" = \"userlevelpermissions\".\"tablename\" LIMIT 1) AS \"EV___tablename\" FROM \"public\".\"userlevelpermissions\"" .
			") \"TMP_TABLE\"";
	...
	protected function useVirtualFields()
	{
		...
		if ($this->BasicSearch->getKeyword() <> "")
			return TRUE;
		if ($this->_tablename->AdvancedSearch->SearchValue <> "" ||
			$this->_tablename->AdvancedSearch->SearchValue2 <> "" ||
			ContainsString($where, " " . $this->_tablename->VirtualExpression . " "))
			return TRUE;
		if (ContainsString($orderBy, " " . $this->_tablename->VirtualExpression . " "))
			return TRUE;
		return FALSE;
	}
	...
	public function renderListRow()
	{
		...
		if ($this->_tablename->VirtualValue <> "") {
			$this->_tablename->ViewValue = $this->_tablename->VirtualValue;
		} else {
