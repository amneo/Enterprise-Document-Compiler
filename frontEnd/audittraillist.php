...
<?php if ($audittrail->username->Visible) { // username ?>
	<?php if ($audittrail->sortUrl($audittrail->username) == "") { ?>
		<th data-name="username" class="<?php echo $audittrail->username->headerCellClass() ?>"><div id="elh_audittrail_username" class="audittrail_username"><div class="ew-table-header-caption"><?php echo $audittrail->username->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="username" class="<?php echo $audittrail->username->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->username) ?>',2);"><div id="elh_audittrail_username" class="audittrail_username">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $audittrail->username->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($audittrail->username->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($audittrail->username->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php echo $audittrail->script->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($audittrail->username->Visible) { // username ?>
		<td data-name="username"<?php echo $audittrail->username->cellAttributes() ?>>
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_username" class="audittrail_username">
<span<?php echo $audittrail->username->viewAttributes() ?>>
<?php echo $audittrail->username->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($audittrail->_action->Visible) { // action ?>
